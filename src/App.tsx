        ...
        <div className="container">
          <div className="hero-text">
            <div className="hero-label">
              ...
              Engineer &middot; Biotech &middot; Open Source
            </div>
            <h1>
        ...
        <div className="container">
          ...
          <div className="about-content">
            <div className="about-text">
              <p>
                I'm an engineer driven by the belief that <strong>great science deserves great software</strong>. 
                My career has been rooted in <strong>biotech</strong>, where I've seen firsthand how the right 
                tools can accelerate discovery and make complex workflows feel effortless.
              </p>
              <br />
              <p>
                ...
                It's the intersection of everything I care about: science, code, and impact.
              </p>
              <br />
              <p>
                Outside of work, I'm usually building side projects, surfing, playing baseball, 
                exploring live music, or finding the next great coffee spot.
              </p>
            </div>
            <div>
